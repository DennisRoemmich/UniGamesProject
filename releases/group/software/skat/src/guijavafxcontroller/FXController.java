...
import guiengine.SkatGame;
import guiengine.SkatPlayer;
...
import guijavafxcontroller.enums.GUIState;
import guiskatguiframework.GameController;
...
public class FXController implements Player, Initializable {
   ...
   /* INITIALIZE */
    ...
    /**
     * handles space click event, not functional
     */
    ...
    /**
     * handles space released event, not functional
     */
