...
/**
 * Represents the gameobject of a gameboard
 * @author DR
 *
 */
public class GameBoard {
	...
	private LinkedList<Integer> gamelog = new LinkedList<>();
		
	/**
	 * Initializes the internal Cell array
	 */
	public GameBoard() {
		this.cellArray = buildCellArray(COLUMN, ROW);
	}
	 ...
	 */
	public void resetGameLog(int lastInput) {
		this.gamelog.remove(lastInput);
	}
	 ...
	 * @param row y-position of the cell
	 */
	public void oCell(int column, int row) {
	 ...
	 * @param row y-position of the cell
	 */
	public void xCell(int column, int row) {
	 ...
	 * @return String Corresponding String value of the gameboard
	 */
	@Override
