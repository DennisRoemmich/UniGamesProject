...
public class OldTilePosition {
    private final int row;
    private final int column;

    public OldTilePosition(int row, int column) {
        this.row = row;
        this.column = column;
    }
    ...
    public OldTilePosition getNext(Direction direction) {
        ...
        return new OldTilePosition(row, column);
    }
}
