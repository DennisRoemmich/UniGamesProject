...
public abstract class GameController {
	...
	protected frameworkchess.GameLog mGameLog;
	protected boolean mIsGameRunning;
	protected List<Player> mPlayers;
	protected frameworkchess.Presenter mPresenter;
	...
	public void createNewGameLog() {
		...
		mGameLog = new frameworkchess.GameLog(dateFormatter.format(now));
	}
	...
	public frameworkchess.Presenter getPresenter() {
		return mPresenter;
	}
